...
func TestFormatSQLValue(t *testing.T) {
	tests := []struct {
		...
		{
			"time",
			time.Date(2026, 5, 29, 15, 27, 53, 460836000, time.FixedZone("+0000", 0)),
			"2026-05-29T15:27:53.460836Z",
		},
	}
...
`
	...
	values, err := plugin.NewValueMap(map[string]interface{}{"a": "1", "active": true})
	if err != nil {
